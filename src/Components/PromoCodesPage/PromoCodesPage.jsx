...
const UnconnectedPromoCodesPage = (props) => {
  ...
  return isLoading ? (
    ...
    <div className="promo-codes-page-wrapper">
      <div className="promo-codes-page-left-section">
        <h3>
          payment ID: <span>{paymentID}</span>
        </h3>
        <h6>Payer Details</h6>
        <Line width="100%" height="1px" color="#F5F6FA" />
        <div className="promo-codes-page-input-wrapper">
          <h5>Full Name</h5>
          <InputBox
            name="payerName"
            type="text"
        ...
        <div className="promo-codes-page-input-row">
          <div
            className="promo-codes-page-input-wrapper"
            style={{ width: "57%" }}
          >
          ...
          >
            ...
            {showSelectRegionError && (
              <small className="promo-codes-page-input-error">
                Select Region
              </small>
            )}
          </div>
        ...
        <div className="promo-codes-page-generate-button-wrapper">
          <Button
            name="generate"
            background="#000000"
            borderRadius="10px"
      ...
      <div className="promo-codes-page-right-section">
        <h5>Preview</h5>
  
        {paymentLink && (
          <div className="promo-codes-page-payment-link-wrapper">
            <p>PaymentLink:</p>
...
let PromoCodesPage = connect(mapStateToProps)(
  UnconnectedPromoCodesPage
);
